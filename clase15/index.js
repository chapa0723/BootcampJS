...
const nombre = "David"
const apellido = "Chaparro"
const persona = {
    "nombre": nombre,
    "apellido": apellido,
}
const sdata = sessionStorage.setItem('persona', persona);
console.log(sdata)

const ldata = localStorage.setItem('persona', persona)
console.log(ldata)

document.cookie = personaCookie;max-age=120
